...
![Api Documentation preview](https://github.com/ffouillet/testrepository/master/web/img/github_readme/api_doc.jpg)
Each request you can make requires you to be authenticated.
To authenticate, just click the 'Authorize' Button.  
![Api Documentation preview](https://github.com/ffouillet/testrepository/master/web/img/github_readme/aauthorize_button.jpg)
